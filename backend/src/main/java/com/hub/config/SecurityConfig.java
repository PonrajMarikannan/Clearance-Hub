	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf(csrf -> csrf.disable()).cors(Customizer.withDefaults()) // Enable CORS
				.authorizeHttpRequests(requests -> requests.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
						.requestMatchers("/ccts/login","/ccts/register", "/ccts/getAllShip", "/ccts/getAllUser", "/ccts/deleteShip/**", "/ccts/updateShip/**", "/ccts/createShip", "/ccts/createExportForm", "/ccts/updateExportForm/**","/ccts/getAllExportForm" ).permitAll()
