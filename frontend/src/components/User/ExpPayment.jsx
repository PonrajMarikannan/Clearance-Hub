...
const ExpPaymentPage = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        expInvoiceId: parseInt(sessionStorage.getItem("InvoiceId"), 10) || 0 
    });
    ...
    const validateAllFields = () => {
        ...
        Object.keys(formData).forEach((field) => {
            if (field !== 'paymentMethod' && field !== 'paymentStatus' && field !== 'expInvoiceId') {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            try {
                ...
                const response = await axios.post('http://localhost:7070/exppay', formData);
