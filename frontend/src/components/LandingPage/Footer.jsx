...
function Footer() {
  return (
    <div>
       <footer class="bg-[#2D3748] text-white py-12 px-4 font-sans tracking-wide">
      <div class="text-center">
        <h6 role="text" class="text-base">Stay connected with us:</h6>
        ...
        <p role="rights" class="text-base">© Clearance Hub. All rights reserved.</p>
      </div>
    </footer>
    </div>
  )
